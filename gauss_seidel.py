...
################################################CONSTRUINDO A INTERFACE################################################
    ...
    layout = [
        [sg.Text('Método de Gauss-Seidel')],
    ...
    while event != 'Voltar':
        ...
        if event == 'Calcular':
            ...
            gauss_seidel(A, B, x0, tol, N)

        if event == 'Tutorial':
            print(
                '____________________________________________TUTORIAL_____________________________________________\n'
                'Por exemplo, para cacular, via método de Gauss-Seidel, uma aproximação da solução do sistema linear\n'
                '	            	            	            	                    4x  +   y  - 2z  =  1\n'
                '                                                                                      x  + 5y + 2z  =  4\n'
                '                                                                                     2x  -  y  + 6z  = -1\n'
                ...
                'As iterações e o erro, via método de Gauss-Seidel, são dados a seguir:\n'
                '                             i           erro                                                  iterações\n'
                '                            1           0.7500000000000                            [ 0.25   0.75  -0.125]^T\n'
                '                            2           0.2500000000000                            [ 0.     0.85  -0.025]^T\n'
                '                            3           0.0450000000000                            [ 0.025       0.805      -0.04083333]^T\n'
                'A solução do sistema é: x3 = [ 0.025       0.805      -0.04083333].\n'
